  ...
  startPlugin() {
    ...
    this.parseTimestamp = (timestampString, timestampObject) => {
      ...
      var timestampFormats = [
        ["%0M", timestampObject.getMonth() < 10 ? "0" + timestampObject.getMonth() : timestampObject.getMonth()],
  ...
  async initInject() {
    ...
    inject(
      ...
      (_, res) => {
        ...
        res.props.children[1].props.children[2] = React.createElement("span", {style: {color: "var(--text-muted", fontSize:"0.75em"}}, timestampParsed)
        return res
      }
    )
  }
